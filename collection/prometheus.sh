...
echo
read -p "Enter node ip address  [192.168.0.114] : " ip_address
ip_address=${ip_address:-192.168.0.114}
...
ansible-playbook -i hosts -e "setup_option=${1} ansible_user=${ansible_user} consul_node1=${consul_node1} consul_node2=${consul_node2} consul_node3=${consul_node3}" prometheus.yml    
