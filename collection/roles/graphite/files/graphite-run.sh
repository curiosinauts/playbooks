...
exec /usr/bin/python3 /opt/graphite/bin/carbon-cache.py start --debug 2>&1 >> /var/log/carbon.log &

rm -f /opt/graphite/storage/carbon-aggregator-a.pid
exec /usr/bin/python3 /opt/graphite/bin/carbon-aggregator.py start --debug 2>&1 >> /var/log/carbon-aggregator.log &
