...
set foldnestmax=20
set winwidth=110                " window width
set guicursor=i:ver25-iCursor   " set cursor vertical line for insert mode

set autoindent                  " Enabile Autoindent
set shiftwidth=4                " set default tab width
set expandtab                   " don't user tab character. use spaces instead.
...
" Highlight word and search https://vim.fandom.com/wiki/Search_for_visually_selected_text
vnoremap // y/<C-R>"<CR>
...
"enable saving of folding on write	
...
" Auto save and load windows state like folding and other stuff
au BufWinLeave *.go mkview
au BufWinEnter *.go silent loadview

" Json and AWS template syntax highlighting
...
" some plugins like nerdtree is installed with pathogen
...
let g:lightline = {
      ...
      \ 'active': {
      \   'left': [ [ 'mode', 'paste' ],
      \             [ 'gitbranch', 'readonly', 'absolutepath', 'tagbar', 'modified' ] ]
      \ },
      \ 'component_function': {
